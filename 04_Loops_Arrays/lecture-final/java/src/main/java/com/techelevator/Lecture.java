...
public class Lecture {
    ...
    */
    public int[] returnArray() {  // named block of code returnArray

        int[] array = { 80, 8080, 443 }; // shortcut to declare and initialize an array all at once
        /*  This comment just explains what is happening on line 10
        int[] array = new int[3];
        array[0] = 80;
        array[1] = 8080;
        array[2] = 443;
    ...
    */
    public int returnLastElementOfParam(int[] passedInArray) {
        // passedInArray.length -- this gives you how many elements are in the array
        return passedInArray[passedInArray.length - 1];  // gives me the last element in ANY SIZED array
    }
    ...
    */
    public boolean returnCountCorrectTimes() {
        ...
        return counter == 5;  // boolean expression
    }
