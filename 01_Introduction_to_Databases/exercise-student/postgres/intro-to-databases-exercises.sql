...
SELECT name, population, lifeexpectancy, surfacearea From country WHERE continent IN ('Asia');
...
SELECT name, population, lifeexpectancy,continent, gnp From country where lifeexpectancy > 80;
...
SELECT name, lifeexpectancy,continent, gnp From country where lifeexpectancy >=70 AND gnp BETWEEN 1 And 100;
...
SELECT 2017 - indepyear AS number_of_years_since_independance FROM country  WHERE indepyear IS NOT NULL;
