...
public class Exercises {
	...
	/*
	 2. done!!! We have two monkeys, a and b, and the parameters aSmile and bSmile indicate if each is smiling.
	...
	/*
	 3. Done Given two int values, return their sum. Unless the two values are the same, then return double their sum.
	 sumDouble(1, 2) → 3
	 sumDouble(3, 2) → 5
	 sumDouble(2, 2) → 8
	 */
	...
	/*
	 4. done Given an int n, return the absolute difference between n and 21, except return double the absolute
	...
	/*
	 5. Done We have a loud talking parrot. The "hour" parameter is the current hour time in the range 0..23.
	...
	/*
	 6. Done Given 2 ints, a and b, return true if one if them is 10 or if their sum is 10.
	 makes10(9, 10) → true
	 makes10(9, 9) → false
	 makes10(1, 9) → true
	 */
	...
	/*
	 7. Done Given 2 int values, return true if one is negative and one is positive. Except if the parameter
	...
	/*
	 8. Done Return true if the given non-negative number is a multiple of 3 or a multiple of 5.
	 (Hint: Think "mod".)
	 or35(3) → true
	 or35(10) → true
	 or35(8) → false
	...
	/*
	 9.Done Given two temperatures, return true if one is less than 0 and the other is greater than 100.
	 icyHot(120, -1) → true
	 icyHot(-1, 120) → true
	 icyHot(2, 120) → false
	 */
	...
	/*
	 10. Done Given 2 int values, return true if either of them is in the range 10..20 inclusive.
	 in1020(12, 99) → true
	 in1020(21, 12) → true
	 in1020(8, 99) → false
	 */
	...
	/*
	 11.Done  We'll say that a number is "teen" if it is in the range 13..19 inclusive. Given 3 int values,
	...
	/*
	 12. Done We'll say that a number is "teen" if it is in the range 13..19 inclusive. Given 2 int values,
	...
	/*
	 13. Done Given three int values, a b c, return the largest.
	 intMax(1, 2, 3) → 3
	 intMax(1, 3, 2) → 3
	 intMax(3, 2, 1) → 3
	 */
	...
	/*
	 14.Done Given 2 int values, return true if they are both in the range 30..40 inclusive, or they are both
	...
	/*
	 15. Done Given 2 int values, return the larger value that is in the range 10..20 inclusive,
	...
	/*
	 16. Done When squirrels get together for a party, they like to have cigars.
	...
	/*
	 17. Done You and your date are trying to get a table at a restaurant. The parameter "you" is the stylishness
	...
	/*
	 18.Done The squirrels in Palo Alto spend most of the day playing. In particular, they play if the temperature
	...
	/*
     19. Done Dessert Island Diner believes a meal isn't a meal without dessert. All meals come with
     a free dessert.
	...
	/*
	 20. Done Given 2 ints, a and b, return their sum. However, sums in the range 10..19 inclusive, are forbidden,
	...
	/*
	 22. Done Given a number n, return true if n is in the range 1..10, inclusive. Unless "outsideMode" is true,
	...
	/*
	 23. Done We'll say a number is special if it is a multiple of 11 or if it is one more than a multiple of 11.
	...
	/*
	 24. Done Return true if the given non-negative number is 1 or 2 more than a multiple of 20.
	 (Hint: Think "mod".)
	 more20(20) → false
	 more20(21) → true
	 more20(22) → true
	...
	/*
	 25. Done Return true if the given non-negative number is a multiple of 3 or 5, but not both.
	 (Hint: Think "mod".)
	 old35(3) → true
	 old35(10) → true
	 old35(15) → false
	...
	/*
	 26.Done Return true if the given non-negative number is 1 or 2 less than a multiple of 20. So for example 38
	...
	/*
	 27. Done Given a non-negative number "num", return true if num is within 2 of a multiple of 10. Note: (a % b)
	...
	/*
	 28.Done Given 2 ints, a and b, return their sum. However, "teen" values in the range 13..19 inclusive, are
	...
	/*
	 29.Done Your cell phone rings. Return true if you should answer it. Normally you answer, except in the morning
	...
	/*
	 30.Done We are having a party with amounts of tea and candy. Return the int outcome of the party encoded as
	...
	/*
	 31. done Given three ints, a b c, return true if it is possible to add two of the ints to get the third.
	 twoAsOne(1, 2, 3) → true
	 twoAsOne(3, 1, 2) → true
	...
	/*
	 32. done Given three ints, a b c, return true if b is greater than a, and c is greater than b. However, with
	...
	/*
	 33. Done Given three ints, a b c, return true if they are in strict increasing order, such as 2 5 11,
	...
	/*
	 34. Done Given 3 int values, a b c, return their sum. However, if one of the values is the same as another
	...
	/*
	 35. done Given 3 int values, a b c, return their sum. However, if one of the values is 13 then it does not
	...
	public int luckySum(int a, int b, int c) {
		if ((a == 13) && (b == 13) && (c == 13)|| (a == 13) && (b == 13)) return 0;
		else {
			if (a == 13) return c;
			if (b == 13) return a ;
			if (c == 13) return a + b;
