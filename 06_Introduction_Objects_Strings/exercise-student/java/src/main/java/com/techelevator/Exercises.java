...
public class Exercises {
    ...
    public String extraEnd(String str) {
        ...
        int chCopy = str.length();
        String lastTwo = (str.substring(chCopy - 2, chCopy));
    ...
    public String right2(String str) {
        int twoChar = str.length() - 2;
        return str.substring(twoChar) + str.substring(0, twoChar);
    ...
    public String withoutEnd2(String str) {
        int lenEnd = str.length();
        if (lenEnd >= 3)
            return str.substring(1, lenEnd - 1);
        return "";
    ...
    public String middleThree(String str) {
        int middleT = str.length() / 2 - 1;
        return str.substring(middleT, middleT + 3);
    ...
    public String stringTimes(String str, int n) {
        String result = "";// assigned for a value will return later
        for (int i = 0; i < n; i++) {
            result += str;
        }
        return result;
    ...
    public String stringX(String str) {
        ...
        String subStr = str.substring( 1, lenX - 1 );
        subStr = subStr.replace( "x", "" );

        return str.charAt( 0 ) + subStr + str.charAt( lenX - 1 );
    }
