...
function displayReviews() {
  ...
  reviews.forEach((review) => {
    ...
    addReviewer(container, review.reviewer); // pass to the function the container and content to be built
    ...
    //  main.appendChild(container); could also be used
  });
}
...
function addReviewer(parent, name) {
  ...
  parent.appendChild(reviewer);  // add to the DOM an h4 with the reviewer's name in it
}
...
function addRating(parent, numberOfStars) {
  ...
  for (let n = 0; n < numberOfStars; n++) {
    ...
    // set the class attribute to ratingStar for the image element
    star.setAttribute('class', 'ratingStar');
    star.src = 'img/star.png'; // can also use star.setAttribute('src','img/star.png');
