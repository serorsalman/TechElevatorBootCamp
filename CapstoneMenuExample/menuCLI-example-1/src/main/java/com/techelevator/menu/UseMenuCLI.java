...
public class UseMenuCLI { // Class representing the MenuCLI process to be used
	...
	public static void main(String[] args) {
		 ...
		 *******************************************************************************/
// String/ constant was created
		final String MAIN_MENU_OPTION_1 = "ADD";
		final String MAIN_MENU_OPTION_2 = "Substract";
		final String MAIN_MENU_OPTION_3 = "Multiply";
		final String MAIN_MENU_OPTION_4 = "Divide";
		 ...
		 **********************************************************************/
// Array to use those options
		final String[] MAIN_MENU_OPTIONS = { MAIN_MENU_OPTION_1, MAIN_MENU_OPTION_2,
				MAIN_MENU_OPTION_3,MAIN_MENU_OPTION_4,
		...
		while (shouldLoop) { // Loop while loop control variable is true
			...
			switch (choice) {
				case MAIN_MENU_OPTION_1: {
					...
					//System.out.println("in choice one: " + choice);//test what we using

					addNums();//call a method

					break;
				}
				case MAIN_MENU_OPTION_2: {
					// process for option 1 choice - good place for a method call
					substractNums();//call a method
					break;
				}
		...
		while (shouldLoop) { // Loop while loop control variable is true
			...
			}//find end of main to start the method after
	...
	private static void substractNums() {
		System.out.println(" In subtract nums");
	}
