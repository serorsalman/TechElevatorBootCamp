...
<<<<<<< HEAD
         -- create attribute
         customer_id serial, -- serial so postgres assigne it for us
         name varchar(64) NOT NULL,
         address varchar(100) NOT NULL,
         phone varchar(16) NULL,
         
         CONSTRAINT pk_customer PRIMARY KEY (customer_id) -- set keys primary
 ...
 (
     ...
     --fk_art_artist -- is just a name for postgres
     --FOREIGN KEY means we are setting up a FK from this table(art) to another table (artist)
     --(artist_id) refers to the art table column name 
     -- REFERENCES -- going to tell psql what the other table is for the fk referenced
     -- artist -- table
  ...
  (
  purchase_id serial,
  customer_id Int NOT NULL, -- we want this to reference the customer table
  art_id int NOT NULL,
...
>>>>>>> ca80ca1b87228eaf5e35ef3b70807a727fa6370a
=======
>>>>>>> 8df3e8f64ce6e70f4af4a110c398e2ef5f2fdfba
