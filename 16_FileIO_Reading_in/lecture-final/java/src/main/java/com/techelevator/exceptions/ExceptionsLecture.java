...
public class ExceptionsLecture {
	...
	public static void main(String[] args) {
		...
		} catch (ArrayIndexOutOfBoundsException e) { // I think the above code MIGHT throw an exception, catch it here
			System.out.println("Uh oh!  An Exception occurred!");
			System.out.println(e.getMessage());  // print out message from the Exception object
		}
		// if no error, we will end up down here
		...
		} catch(ArrayIndexOutOfBoundsException e){  // more specific exception
			System.out.println("Array error has occurred!!!!");
			System.out.println(e.getMessage());
		} catch (Exception e) {  // to the more general
			System.out.println("Hmmmm, another error occurred!");
			System.out.println(e.getMessage()); // what is the error?
		}

			
			
		System.out.println("After doSomethingDangerous() has run");
		...
		while (true) {  // while true is ALWAYS TRUE -- infinite loop!!
			try {
		...
		try {
			...
			//if I don't put any code in the catch block, the program continues to run with no error
			System.out.println(" You have overdrawn your account!");
			System.out.println(" The amount would be overdrawn by " + e.getOverdraftAmount());
		}
