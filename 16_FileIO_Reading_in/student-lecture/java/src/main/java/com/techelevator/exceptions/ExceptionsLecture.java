...
public class ExceptionsLecture {
    ...
    public static void main(String[] args) {
        ...
        } catch (Exception e) {// the more general
            System.out.println("Hmmm, another error occurred!");
        ...
        while (true) {// while true is always true-- infinite loop!! to move on
            try {
		...
		try {
		    ...
		    //if I dont put any code in the catch block, the program continues to run with no error
