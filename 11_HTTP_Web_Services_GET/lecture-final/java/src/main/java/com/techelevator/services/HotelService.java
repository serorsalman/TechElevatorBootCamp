...
public class HotelService {
    ...
    // create a REST temple object and instantiate it
    ...
    public Hotel getHotelById(int id) {
        ...
        return restTemplate.getForObject(API_BASE_URL + "hotels/" + id,
               Hotel.class );
    }

    public Review[] getReviewsByHotelId(int hotelID) {
    	  return restTemplate.getForObject(API_BASE_URL + "hotels/" + hotelID +
