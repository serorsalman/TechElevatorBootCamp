...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        generalAuction.placeBid(new Bid("Ratik", 23));
        System.out.println("Bidder: " + generalAuction.getHighBid().getBidder());
        System.out.println("   Amount: " + generalAuction.getHighBid().getBidAmount());
        ...
        for (Bid bid: generalAuction.getAllBids()){  // generalAuction.getAllBigs returns a List
        ...
        System.out.println("Is Bob's bid high enough? Name: " +
                reserveAuction.getHighBid().getBidder() + " Amount: " +
                reserveAuction.getHighBid().getBidAmount());

        reserveAuction.placeBid(new Bid("Kevin", 510));
        System.out.println("Is Kevin's bid high enough? Name: " +
                reserveAuction.getHighBid().getBidder() + " Amount: " +
                reserveAuction.getHighBid().getBidAmount());
        ...
        auctionItems[1] = new BuyoutAuction("Toy Truck", 2);
        ...
        for (Auction auction: auctionItems){
            System.out.println("Item for sale: " + auction.getItemForSale() + " High Bid: " +
